...
def read(model, cha, E, T, dist, end="tot"):
    ...
    for i in range(1):
        ...
        df1 = pd.read_csv(f"/junofs/users/miaoyu/supernova/simulation/toyMC/results/Garching82703_10kpc_NO_pESeESIBD_0.15MeV_fitTmax20ms_tot_new_doFit_unbinnedNLL_PosiToyData.csv")
        df2 = pd.read_csv(f"/junofs/users/miaoyu/supernova/simulation/toyMC/results/Garching82703_10kpc_IO_pESeESIBD_0.15MeV_fitTmax20ms_tot_new_doFit_unbinnedNLL_PosiToyData.csv")
...
def draw():
    ...
    _, _, sens_dataNO, _, _, sens_dataIO            = read("Garching82703", "pESeESIBD", 0.15, 50, 10, end="_new__start0end100_doFit_unbinned_PoisToyData")
    ...
    #h4 = ax.hist(-sens_dataIO_bin,  bins=100, range=(-200, 0),  alpha=0.5, label="true IO (0.01 ms binning)", histtype="step", lw=2, color="darkviolet")
