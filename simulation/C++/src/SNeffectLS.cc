...
SNeffectLS::SNeffectLS():
    ...
    //double fracLAB = 0.1;
    //double Na = 6.02e23;
    //double fracP0 = 11.1e-2;
    //double fracO = 1 - fracP0;
    //double fracP = 12e-2;
    //double fracC = 88e-2;
    //double molarH = 1.;//g/mol
    //double molarC = 12.;
...
double SNeffectLS::getPosiNonl(double T) {
    return gPosiNonl->Eval(T+1.022);
}
...
double SNeffectLS::getPosiTfromEvis(double Evis) {
    return gPosiNonlInv->Eval(Evis) - 1.022;
}
